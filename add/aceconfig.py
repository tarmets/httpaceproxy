...
class AceConfig(acedefconfig.AceDefConfig):
    ...
    acecmd = '/opt/acestream.engine/start-engine --client-console --bind-all --access-token WkRi4UeG8p --cache-dir /tmp/.ACEStream --state-dir /tmp/.ACEStream --live-cache-type memory --vod-cache-type memory --live-buffer 25 --vod-buffer 10 --vod-drop-max-age 120'
    # Ace Stream API key
