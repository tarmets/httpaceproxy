...
class AceConfig(acedefconfig.AceDefConfig):
    ...
    acecmd = '/opt/acestream.engine/start-engine --client-console --bind-all --access-token RlTgC3WkUFt --cache-dir /tmp/.ACEStream --state-dir /tmp/.ACEStream --live-cache-type memory --vod-cache-type memory --live-buffer 5 --vod-buffer 10 --vod-drop-max-age 120'
    # Ace Stream API key
